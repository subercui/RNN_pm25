...
x,y=np.mgrid[-1:1:0.25,-1:1:0.25]
x=x.reshape(-1)
y=y.reshape(-1)
class RNNPm25Dataset(object):
    ...
    ''' 
    def __init__(self,lon=116.3883+x,lat=39.9289+y,start='2015090302',stop='2015092902',steps=int(t_predict/3+8)):
...
if __name__ == '__main__':
    ...
    savefile(obj.input_data,savedir+'BeijingDimPlusTrueTest'+today.strftime('%Y%m%d')+'0903-0929.pkl.gz')
    ...
    print "saved at "+savedir+'BeijingDimPlusTrueTest'+today.strftime('%Y%m%d')+'0903-0929.pkl.gz'

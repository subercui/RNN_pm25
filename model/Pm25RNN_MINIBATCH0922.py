...
class Model:
    ...
    def create_cost_fun (self):                                 
        self.cost = (self.predictions[:8] - self.pm25target[:8]).norm(L=2)
...
dataset='/data/pm25data/dataset/RNNPm25Dataset'+today.strftime('%Y%m%d')+'_t10p1000shuffled.pkl.gz'
...
for k in xrange(50):#run k epochs
    error_addup=0
...
# SAVE MODEL #
##############
savedir='/data/pm25data/model/testRNNModel'+today.strftime('%Y%m%d')+'.pkl.gz'
